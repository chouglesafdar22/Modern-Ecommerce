...
function ProductCard({ product }: any) {
    ...
    return (
        <motion.div
            ...
            className="group flex flex-row xl:gap-4 lg:gap-3 md:gap-2.5 sm:gap-1.5 gap-0.5 items-center rounded-xl xl:py-3.5 lg:py-3 md:py-2.5 sm:py-2 py-1.5 lg:px-3.5 md:px-2.5 sm:px-1.5 px-1 max-w-[350px] xl:max-w-[480px] xl:h-[250px] h-52 bg-gray-100 font-sans"
        >
            {/* Image Box */}
            <motion.div
